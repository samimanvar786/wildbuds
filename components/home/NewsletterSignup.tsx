...
export default function NewsletterSignup() {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-[#03312f] to-[#024a46]">
        ...
        <div className="text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-white/90 text-lg mb-8">
              Subscribe to our newsletter for exclusive plant care tips, seasonal guides, 
              and special offers. Plus, get 15% off your first order!
            </p>

            {isSubscribed ? (
              <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-6 mb-8">
                <h3 className="text-white font-semibold mb-2">Welcome to Wild Buds!</h3>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto mb-8">
                ...
                <Button 
                  type="submit"
                  className="bg-white text-[#03312f] hover:bg-gray-100 font-semibold px-8 whitespace-nowrap"
                >
                  Subscribe Now
                </Button>
              </form>
